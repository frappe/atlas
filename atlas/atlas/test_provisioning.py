...
from atlas.atlas.core.provisioning import provision_region, region_server_title


class TestRegionServerTitle(FrappeTestCase):
	def test_region_reads_atlas_settings(self):
		with patch("atlas.atlas.core.placement.atlas_region", return_value="blr1"):
	...
	def test_region_fails_loud_when_unset(self):
		...
		with patch(
			"atlas.atlas.core.placement.atlas_region",
