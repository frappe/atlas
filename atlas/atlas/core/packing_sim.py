...
(`atlas.atlas.core.packing.rank_key`), so a strategy that wins here is the one to set on
...
Run:  python3 -m atlas.atlas.core.packing_sim --help
"""
...
from atlas.atlas.core import packing, packing_metrics
