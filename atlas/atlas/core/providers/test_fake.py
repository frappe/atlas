...
from atlas.atlas.core.providers.base import Networking, ProvisionRequest, SshKey
from atlas.atlas.core.providers.fake import (
	DEFAULT_FAKE_IMAGE,
	DEFAULT_FAKE_SIZE,
	FakeProvider,
...
class TestFakeProvider(IntegrationTestCase):
	...
	def test_list_servers_returns_canned_inventory(self) -> None:
		from atlas.atlas.core.providers.fake import FAKE_DISCOVERED_TITLES
