...
if TYPE_CHECKING:
	from atlas.atlas.core.providers.base import Provider
...
def _load_implementations() -> None:
	...
	import atlas.atlas.core.providers.digitalocean
	import atlas.atlas.core.providers.fake
	import atlas.atlas.core.providers.scaleway
	import atlas.atlas.core.providers.self_managed
