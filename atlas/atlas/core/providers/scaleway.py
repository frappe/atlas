...
install. Delegates HTTP to `atlas.atlas.core.scaleway.ScalewayClient`.
...
from atlas.atlas.core.providers import register
...
from atlas.atlas.core.scaleway import (
...
class ScalewayProvider(Provider):
	...
	def prepare_host(self, server) -> None:
		...
		import atlas
		from atlas.atlas.core._ssh.transport import Connection, run_ssh, ssh_key_file, wait_for_ssh
