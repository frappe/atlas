...
class VirtualMachine(Document):
	...
	def _ipv4_link_variables(self) -> dict:
		return vm_provisioning.ipv4_link_variables(self)

	def _private_network_variables(self) -> dict:
		return vm_provisioning.private_network_variables(self)

	def _data_disk_variables(self) -> dict:
		return vm_provisioning.data_disk_variables(self)
...
def _routing_base_url() -> str:
	return vm_provisioning.routing_base_url()


def _cgroup_values(interleaved: list[str]) -> list[str]:
	return vm_provisioning.cgroup_values(interleaved)
