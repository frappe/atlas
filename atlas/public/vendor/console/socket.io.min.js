...
!(function (e, t) {
	...
	var me = "function" == typeof ArrayBuffer,
		...
		we =
			"function" == typeof Blob ||
			("undefined" != typeof Blob && "[object BlobConstructor]" === ke.call(Blob)),
		_e =
			"function" == typeof File ||
			("undefined" != typeof File && "[object FileConstructor]" === ke.call(File));
	function Ee(e) {
		return (
	...
	function Oe(e) {
		var t = [],
			n = e.data,
			r = e;
		return (r.data = Te(n, t)), (r.attachments = t.length), { packet: r, buffers: t };
	}
	function Te(t, n) {
		if (!t) return t;
		if (Ee(t)) {
